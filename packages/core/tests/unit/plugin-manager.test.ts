...
describe('PluginManager', () => {
  ...
  describe('Plugin registration', () => {
    ...
    it('should register a plugin from config', async () => {
      ...
      const loadPluginSpy = vi
        .spyOn(pluginManager as any, 'loadPluginFromPackage')
  ...
  describe('Dynamic loading', () => {
    ...
    it('should load a plugin from a local path', async () => {
      ...
      const loadPluginSpy = vi
        .spyOn(pluginManager as any, 'loadPluginFromLocalPath')
        .mockResolvedValue(mockPlugin);
    ...
    it('should load a plugin from git', async () => {
      ...
      const loadPluginSpy = vi
        .spyOn(pluginManager as any, 'loadPluginFromGit')
        .mockResolvedValue(mockPlugin);
