...
describe('TemplateEngine', () => {
  ...
  describe('resolve', () => {
    ...
    it('should resolve config variables', async () => {
      ...
      const result = await templateEngine.resolve(
    ...
    it('should resolve variables', async () => {
      ...
      const result = await templateEngine.resolve(
        'User: ${variables.user.name} (${variables.user.email})',
        context
      );
    ...
    it('should resolve template functions', async () => {
      ...
      const result = await templateEngine.resolve(
        'Result: ${string.uppercase("hello")} ${string.concat("world", "!")}'
      );
  ...
  describe('resolveObject', () => {
    ...
    it('should resolve templates in nested arrays', async () => {
      ...
      const obj = {
        values: ['${env.VALUE1}', ['${env.VALUE2}', { nested: '${env.VALUE3}' }]],
      };
