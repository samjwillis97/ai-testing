...
requests:
  ...
  describe('getCollections', () => {
    ...
    it('should throw an error if reading the directory fails', async () => {
      ...
      await expect(getCollections(COLLECTION_DIR)).rejects.toThrow('Failed to read collections directory');
      expect(fs.readdir).toHaveBeenCalledWith(COLLECTION_DIR);
    });
  });
  ...
  describe('getRequests', () => {
    ...
    it('should throw an error if collection is not found', async () => {
      ...
      // Call the function and expect it to throw
      await expect(getRequests(COLLECTION_DIR, 'non-existent')).rejects.toThrow('Failed to read requests: Collection \'non-existent\' not found');
    });
    ...
    it('should throw an error if reading the collection fails', async () => {
      ...
      // Call the function and expect it to throw
      await expect(getRequests(COLLECTION_DIR, 'collection1')).rejects.toThrow('Failed to load collection');
    });
  ...
  describe('getRequest', () => {
    ...
    it('should apply snake_case base_url from collection to request', async () => {
      ...
      // Call the function
      const request = await getRequest(COLLECTION_DIR, 'snake-base-url-collection', 'get-user-with-snake-base');
    ...
    it('should not override existing baseUrl in request', async () => {
      ...
      // Call the function
      const request = await getRequest(COLLECTION_DIR, 'base-url-collection', 'get-user-with-own-base');
    ...
    it('should throw an error if request is not found in collection', async () => {
      ...
      // Call the function and expect it to throw
      await expect(getRequest(COLLECTION_DIR, 'collection1', 'non-existent')).rejects.toThrow('Failed to get request: Request \'non-existent\' not found in collection \'collection1\'');
    });
    ...
    it('should throw an error for unsupported file format in content', async () => {
      ...
      await expect(getRequest(COLLECTION_DIR, 'collection', 'get-users')).rejects.toThrow('Failed to get request: Failed to load collection:');
    });
    ...
    it('should handle null requests object in collection', async () => {
      ...
      // Call the function and expect it to throw
      await expect(getRequest(COLLECTION_DIR, 'invalid-collection', 'get-users')).rejects.toThrow('Failed to get request: Request \'get-users\' not found in collection \'invalid-collection\'');
    });
    ...
    it('should throw an error when finding collection file fails', async () => {
      ...
      // Call the function and expect it to throw
      await expect(getRequest(COLLECTION_DIR, 'collection1', 'get-users')).rejects.toThrow('Failed to get request: Failed to find collection: Permission denied');
    });
    ...
    it('should handle missing requests property in collection', async () => {
      ...
      // Call the function and expect it to throw
      await expect(getRequest(COLLECTION_DIR, 'collection', 'get-users')).rejects.toThrow('Failed to get request: Request \'get-users\' not found in collection \'collection\'');
    });
    ...
    it('should handle non-Error objects in error handling', async () => {
      ...
      // Call the function and expect it to throw
      await expect(getRequest(COLLECTION_DIR, 'collection', 'get-users')).rejects.toThrow('Failed to get request: Failed to load collection: Not an Error object');
    });
  });
});
