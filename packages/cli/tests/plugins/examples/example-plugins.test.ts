...
import { CLIPluginContext, CommandHandler, OutputFormatter, ResponseVisualizer, CompletionHandler } from '../../../src/types/cli-plugin.types.js';
...
describe('Example Plugins', () => {
  ...
  describe('Plugin Registration', () => {
    it('should test plugin registration functions', () => {
      ...
      expect(context.registerOutputFormatter).toHaveBeenCalledWith('markdown', expect.any(Function));
